...
let confirmationText = document.querySelector('.js-confirmation-text');

let resetScoreConfirmation = () => {
  ...
  ">
    <div style="
      margin-right: 10px;
    ">Are you sure you want to reset the score?</div>
...
let resetScoreButton = document.querySelector('.js-reset-score-button');
